$(document).on('ajaxComplete ready', function () {
    ...
    $('[data-provides="anomaly.field_type.image"]:not([data-initialized])').each(function () {
        ...
        var $dataStore = $('[name="' + field + '[data]"]');
        var $idStore = $('[name="' + field + '[id]"]');
        ...
        $modal.on('click', '[data-file]', function (e) {
            ...
            $wrapper.find('.selected').load('/streams/image-field_type/selected?uploaded=' + file, function () {
                $modal.modal('hide');
            });
            ...
            $image
                .cropper('replace', '/streams/image-field_type/view/' + file)
                .cropper('reset');
